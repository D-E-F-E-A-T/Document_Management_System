...
class Dashboard {
    ...
    public function getFact() {
        return $this->fetchJSON("https://uselessfacts.jsph.pl/today.json", "text");
    }

    public function getFactCats() {
        return $this->fetchJSON("https://cat-fact.herokuapp.com/facts/random", "text");
    }

    public function getRandomJokeAboutProgramming() {
        return $this->fetchJSON("https://sv443.net/jokeapi/category/Programming?blacklistFlags=nsfw", "joke");
    }
