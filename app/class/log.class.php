...
class Log {
    public function view() {
        ...
        $content .= '<thead><tr><th scope="col">'. LANG_PROFILE_LOG_TABLE_ip .'</th><th scope="col">'. LANG_PROFILE_LOG_TABLE_ua .'</th><th scope="col">'. LANG_PROFILE_LOG_TABLE_username .'</th><th scope="col">'. LANG_PROFILE_LOG_TABLE_date .'</th></tr></thead>';
        $content .= '<tbody>';
