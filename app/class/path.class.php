...
class Path
{
    ...
    private function returnAssetsPath()
    {
        return $this->basePath . "assets/";
    }
    private function returnClassPath()
    {
        return $this->basePath . "class/";
    }
    private function returnControllerPath()
    {
        return $this->basePath . "controller/";
    }
    private function returnLangPath()
    {
        return $this->basePath . "lang/";
    }
    private function returnRoutesPath()
    {
        return $this->basePath . "routes/";
    }
    private function returnViewsPath()
    {
