...
define("LANG_NAV_password", "Change password");
define("LANG_NAV_sign_out", "Sign out");
define("LANG_SIGNIN_title", "Please sign in");
define("LANG_SIGNIN_username", "Email address");
define("LANG_SIGNIN_password", "Password");
define("LANG_SIGNIN_button", "Sign in");
define("LANG_SIGNIN_error", "Username or password is incorrect.");
define("LANG_NOTES_TABLE_heading", "All notes:");
define("LANG_NOTES_TABLE_btn_new", "Make new note");
define("LANG_NOTES_TABLE_title", "Title");
define("LANG_NOTES_TABLE_lastedit", "Last edited");
define("LANG_NOTES_TABLE_actions", "Actions");
define("LANG_NOTES_TABLE_BTN_edit", "Edit");
define("LANG_NOTES_TABLE_BTN_remove", "Remove");
define("LANG_NOTES_EDIT_heading", "Edit note");
define("LANG_NOTES_NEW_heading", "New note");
define("LANG_NOTES_NEW_title", "Title");
